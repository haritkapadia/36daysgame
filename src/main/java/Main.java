...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
        ...
        java.net.URL musicResource = Thread.currentThread().getContextClassLoader().getResource("Walking-dreamy-bass-synth-loop.wav");
        
		Clip clip;
		try{
			AudioInputStream audioStream = AudioSystem.getAudioInputStream(musicResource.openStream());
