	...
	AboutPane(Scene scene, Stage stage) {
		...
		getChildren().add(new HBox(){{
			getChildren().add(new ImageView(){{
				setImage(new Image(AboutPane.class.getResource("/img/sierratech-logo.png").toExternalForm()){{
		...
		getStylesheets().add(AboutPane.class.getResource("/stylesheet.css").toExternalForm());
