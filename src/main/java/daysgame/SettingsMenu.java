...
public class SettingsMenu extends StackPane {
        ...
        public void addGameButtons(StackPane gamePane, Game game){
                ...
                speedButton = new ToggleButton(){{
                        setId("speedbutton");
                        setOnAction (e -> {
                                game.getWorld().getStopwatch().setSpeed(3-game.getWorld().getStopwatch().getSpeed());
                        });
                }};
        ...
        SettingsMenu (Scene scene, Stage stage, Boolean mainMenu) {
                ...
                getStylesheets().add(SettingsMenu.class.getResource("/stylesheet.css").toExternalForm());
        }
