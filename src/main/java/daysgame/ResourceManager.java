...
public final class ResourceManager {
                ...
                try {
                        for(Direction d : Direction.values()) {
                                ...
                                for(int i = 0; i < images.length; i++) {
                                    images[i] = new Image(ResourceManager.class.getResource("/img/sprite" + (i + 1 + d.ordinal() * 3) + ".png").toExternalForm());
    ...
    private static final Image fireSprite = new Image(ResourceManager.class.getResource("/img/fire_small.png").toExternalForm());
        ...
        public static Block getBlock(BlockKey b) {
                ...
                if(c == null) {
                        if(ItemKey.valueOf(b.name()) != null)
                            blocks.put(b, new PortableBlock(ResourceManager.class.getResource("/img/missing.png").toExternalForm(), ItemKey.valueOf(b.name())));
                }
                return blocks.get(b);
        }
        ...
        public static BlockKey getPortableBlock(ItemKey k) {
                if(blocks.get(BlockKey.valueOf(k.name())) == null)
                    blocks.put(BlockKey.valueOf(k.name()), new PortableBlock(ResourceManager.class.getResource("/img/missing.png").toExternalForm(), k));
