...
public class MainMenuPane extends VBox {
        ...
        MainMenuPane(Scene scene, Stage stage) {
                ...
                getChildren().add(new Button("World Select"){{
                        ...
                        setOnAction(e -> Main.setPane(scene, new WorldSelectPane(scene, Paths.get(System.getProperty("user.home"), "Desktop", "36daysfiles"))));
                }});
                n.addAndGet(500);
                ...
                getChildren().add(new Button("High Scores"){{
                        ...
                        setCache(true);
                        setCacheHint(CacheHint.SPEED);
                        setOnAction(e -> Main.setPane(scene, new HighScoresPane(scene, Paths.get(System.getProperty("user.home"), "Desktop", "36daysfiles").resolve("worlds"))));
                }});
                n.addAndGet(500);
